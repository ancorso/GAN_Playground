...
Dhist = BSON.load("BCE_BS128_LR0.0001/d_hist_ld2.bson")[:Dhist]
Ghist = BSON.load("BCE_BS128_LR0.0001/g_hist_ld2.bson")[:Ghist]

plot(Dhist, label="Dhist")
plot!(Ghist, label="Ghist")